...
namespace Drupal\dubbot_default_content;
 ...
 *
 * @internal
 *   This code is only for use by the DubBot demo: Content module.
 */
class InstallHelper implements ContainerInjectionInterface {
  ...
  protected function getModulePath() {
    $this->module_path = $this->moduleHandler->getModule('dubbot_default_content')->getPath();
    return $this;
  }
  ...
  public function deleteImportedContent() {
    $uuids = $this->state->get('demo_dubbot_content_uuids', []);
  ...
  protected function storeCreatedContentUuids(array $uuids) {
    $uuids = $this->state->get('demo_dubbot_content_uuids', []) + $uuids;
    $this->state->set('demo_dubbot_content_uuids', $uuids);
  }
